...
export default function EstimateCostsTab() {
    ...
    // handler for number inputs to prevent concatenation
    const handleNumberChange = (setter) => (e) => {
        ...
        // Parse as number, remove leading zeros and invalid characters
    ...
    // Handle focus to select all text for easier replacement
    const handleFocus = (e) => {
        e.target.select();
    };
    ...
    const calculateCosts = () => {
        ...
        if (disbAmt < 0)
            newErrors.disbursementAmount = "Disbursement amount cannot be negative";
        ...
        <Container maxWidth="lg" sx={{ my: 4 }}>
            ...
            >
                ...
                <Typography variant="subtitle1" sx={{ opacity: 0.9, mb: 3 }}>
                    Plan your education journey with our comprehensive cost
                    estimator
                </Typography>
                        ...
                        <CardContent>
                            ...
                            >
                                ...
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={12} md={6}>
                                        <FormControl fullWidth>
                                            <InputLabel id="interest-rate-label">
                                                Interest Rate (%)
                                            </InputLabel>
                                            <Select
                            ...
                            >
                                ...
                                <FormControl
                                    fullWidth
                                    error={!!errors.nocPrograms}
                                >
                                    <InputLabel id="noc-programs-label">
                                        Programs
                                    </InputLabel>
                                    <Select
                                    ...
                                    <Grid item xs={12} md={6}>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    NPR{" "}
                                                    {getEducationTax().toLocaleString()}
                                                </Typography>
                                            </Box>
                                            {loanAmount > 0 && (
                                                <Alert
                            ...
                            >
                                ...
                                <FormControl fullWidth>
                                    ...
                                    <Typography
                                        ...
                                        sx={{ mt: 1 }}
                                    >
                                        Normally AUD 2,500 depending on stay
                                        length
                                    </Typography>
                                    <Box
                                        sx={{
                        ...
                        <CardContent>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        NPR{" "}
                                        {getCategoryTotal("visa").toLocaleString()}
                                    </Typography>
                                </Box>
                            </Paper>
                        </CardContent>
            ...
            {showResults && (
                <Card
                    elevation={4}
                    sx={{ mt: 4, bgcolor: `${primaryColor}05`, overflow: "hidden" }}
                >
                    <CardHeader
                        title={
                            <Box
                        ...
                        <Grid container spacing={2} sx={{ mb: 4 }}>
                            ...
                            <Grid item xs={6} sm={4} md={2.4}>
                                ...
                                >
                                    ...
                                    >
                                        NPR{" "}
                                        {getCategoryTotal("gs").toLocaleString()}
                                    </Typography>
                                </Paper>
                            </Grid>
                            <Grid item xs={6} sm={4} md={2.4}>
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    ...
                                    >
                                        ...
                                        <TableCell align="right">
                                            {getBankProcessingFee().toLocaleString()}
                                        </TableCell>
                                    </TableRow>
                                    <TableRow
                                        sx={{
                                    ...
                                    >
                                        ...
                                        <TableCell align="right">
                                            {getTranslationCost().toLocaleString()}
                                        </TableCell>
                                    </TableRow>
                                    <TableRow
                                        sx={{
                                    ...
                                    >
                                        ...
                                        <TableCell align="right">
                                            {getEngineeringCost().toLocaleString()}
                                        </TableCell>
                                    </TableRow>
                                    <TableRow
                                        sx={{
                                    ...
                                    >
                                        <TableCell>
                                            NOC ({nocPrograms} programs)
                                        </TableCell>
                                        <TableCell align="right">
                                            {getNocCost().toLocaleString()}
                                        </TableCell>
                                    </TableRow>
                                    ...
                                    >
                                        <TableCell>
                                            Medical (
                                            {medicalProvider === "Norvic"
                                                ? "Norvic"
                                                : "IOM Nepal"}
                                            )
                                        </TableCell>
                                        <TableCell align="right">
                                            {getMedicalCost().toLocaleString()}
                                        </TableCell>
                                    </TableRow>
                                ...
                                <Grid container spacing={2} sx={{ mt: 1 }}>
                                    ...
                                    <Grid item xs={12} md={4}>
                                        ...
                                        >
                                            ...
                                            >
                                                NPR{" "}
                                                {getMonthlyInstallment().toLocaleString()}
                                            </Typography>
                                        </Paper>
                                    </Grid>
                                </Grid>
                    ...
                    <CardActions
                        sx={{
                            ...
                            background:
                                "linear-gradient(to right, rgba(79, 70, 229, 0.05), rgba(156, 39, 176, 0.05))",
                        }}
                    >
                        <Button
                            fullWidth
